...
class Users extends \core\AdminLogicClass {
 ...
 public function __construct(){
  ...
  if( isset($this->get['command']) ){
   ...
   else if( $this->get['command'] == 'searchResults' ){
    $this->search();
   }
   ...
   else if( $this->post['command'] == 'addGroup' ){
    $this->addGroup();
   }
   else if( $this->post['command'] == 'deleteGroup' ){
    $this->deleteGroup();
   }
   else if( $this->post['command'] == 'login' ){
    $this->login();
   }
  }
 }
 ...
 private function edit(){
  ...
  if( !isset($this->post['email']) || !isset($this->post['bot']) || ($this->post['bot'] != 0 && $this->post['bot'] != 1) ||
     !isset($this->post['blocked']) || ($this->post['blocked'] != 0 && $this->post['blocked'] != 1) )
   return;
 ...
 private function add(){
  if( !isset($this->post['username']) || $this->post['username'] == '' || !isset($this->post['email']) ||
     !isset($this->post['bot']) || ($this->post['bot'] != 0 && $this->post['bot'] != 1) || !isset($this->post['password']) ||
     $this->post['password'] == '' || !isset($this->post['password2']) || $this->post['password2'] == '' )
   return;
  
  if( !$this->service_Security->checkEmail($this->post['email']) || !$this->model_User->checkUsername($this->post['username']) ||
