...
class Headers extends Service {
  ...
  *
  * @param String $s_contentType content type
  */
  ...
  *
  * @param int $i_modified modified time as a timestamp
  */
  ...
  *
  * @param int $i_cache cache time in seconds
  */
  ...
  *
  * @param int $i_length length in bytes
  */
  ...
  * Program wil halt
  *
  * @param String $s_file file location
  * @param String $s_contentType content type
  */
  ...
  * Program wil halt
  *
  * @param String $s_content content to download
  * @param String $s_contentType content type
  * @param String $s_name name of the download
  */
  ...
  * Sets a header
  *
  * @param String $s_key header key
  * @param String $s_content header value
  */
  ...
  * Program wil halt
  *
  * @param String $s_location redirect location
  */
