...
class Memory {
  ...
  *
  * @param String $s_class class name
  ...
  *
  * @param String $s_interface interface name
 ...
 private static function loadModule( $s_name, $s_memoryType, $a_data, $s_fallback = '' ){
  ...
  if( (class_exists($a_data['userNamespace'] . $s_name)) || (class_exists($a_data['systemNamespace'] . $s_name)) ){}
   ...
   throw new \MemoryException('Class ' . $s_name . ' and class ' . $s_memoryType . $s_fallback . '_' . $s_name . ' not found in ' . $a_data['userPath'] .
      ' and in ' . $a_data['systemPath'] . '.
      		Namespaces ' . $a_data['userNamespace'] . ' and ' .
      $a_data['systemNamespace'] . '.');
  }
  ...
  * @param bool $bo_data to true to use the data directory
  ...
  *
  * @param String $s_type The type (helper|helper-data|model|model-data|service|service-data)
  * @param String $s_name name of the object
  ...
  * Loads an interface
  *
  * @param String $s_interface interface
  ...
  *
  * @param String $s_caller class name
  * @param String $s_filename source file name
  ...
  *
  * @param String $s_type the variable schould be
  * @param object $value that needs to be checked
