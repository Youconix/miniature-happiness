...
class Privileges {
  ...
  * @param core\services\Headers $service_Headers header service
  ...
  *
  * @param array $a_userGroups The user group levels
  */
 protected function checkCommand( $a_userGroups ){
  $this->service_QueryBuilder->select('group_pages_command', 'groupID,minLevel')->getWhere()->addAnd(array( 
    'page',
    'command' 
  ), array( 
    's',
