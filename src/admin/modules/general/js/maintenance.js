...
Maintenance.prototype.mainScreen = function () {
  $('#maintenance_check_database_label').click(function () {
    ...
    setTimeout(function () {
      $.get(maintenance.address + 'performAction/checkDatabase', function (response) {
  ...
  $('#maintenance_optimize_database_label').click(function () {
    ...
    setTimeout(function () {
      $.get(maintenance.address + 'performAction/optimizeDatabase', function (response) {
  ...
  $('#maintenance_clean_stats_label').click(function () {
    ...
    setTimeout(function () {
      $.get(maintenance.address + 'performAction/cleanStats', function (response) {
