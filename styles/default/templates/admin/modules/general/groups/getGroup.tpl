	...
	<section class="item_body">
		...
		<fieldset>
			<label for="automatic" class="label">{headerAutomatic}</label> <input
				type="checkbox" name="automatic" id="default_1"{defaultChecked}>
		</fieldset>
		<fieldset>
			<input type="hidden" id="id" value="{id}"> <input
				type="button" value="{buttonSubmit}" id="groupEditSave"> <input
				type="button" value="{buttonCancel}" id="groupCancel"
				style="float: right">
		</fieldset>
	</section>
</section>