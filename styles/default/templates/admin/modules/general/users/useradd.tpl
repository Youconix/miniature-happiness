	...
	<section class="item_body">
	    <fieldset>
            ...
            <input type="text" id="username" name="username" data-error-message="De gebruikersnaam is niet ingevuld" required>
        </fieldset>
		<fieldset>
			<label for="email" class="label">{emailHeader}</label>
			<input type="email" id="email" name="email" data-error-message="Het E-mail adres is niet ingevuld of ongeldig" required>
		</fieldset>
		<fieldset>
        ...
        <fieldset>
            ...
            <input type="password" name="password" id="password1" data-error-message="Het wachtwoord is niet ingevuld" required>
        </fieldset>
        <fieldset>
            <label for="password2" class="label">Wachtwoord herhalen</label>
            <input type="password" name="password2" id="password2" data-error-message="Het wachtwoord is niet ingevuld" required>
        </fieldset>
        <fieldset>
                <input type="submit" value="Opslaan" id="userSaveButton">
