...
class InputFactory {
   ...
   * 
   * @param String  $s_name   The name of the field
   * @param bool    $bo_local Set to true to localize the field
  ...
  /**
	 ...
	 *
	 * @param   String  $s_name     The name of the button
	 * @param   String  $s_type     The type of the button
	 * @param   String  $s_value    The default text of the button
	 * @param   String	$s_htmlType	The HTML type
   * @throws  \Exception  If the type is invalid
	 */
...
class Textarea extends HtmlFormItem {
	 ...
	 *
	 * @param String $s_name	name
	 * @param String $s_value	content
	 */
	public function __construct($s_name, $s_value){
		$this->s_name = $s_name;
	 ...
	 *
	 * @param int $i_rows	number of rows
	 */
	 ...
	 *
	 * @param int $i_cols	number of cols
	 */
