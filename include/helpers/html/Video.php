...
class Audio extends HtmlItem {
	 ...
	 * @param String $s_type	The audio type
	 */
	public function __construct($s_url,$s_type){
		$this->a_sources[]	= array($s_url,$s_type);
	 ...
	 * Sets the auto play
	 *
	 * @param boolean $bo_autoplay	set to true to autoplay
	 */
	 ...
	 * Shows the controls
	 *
	 * @param boolean $bo_show	Set to true to show the controls
	 */
	 ...
	 * Plays endless
	 *
	 * @param boolean $bo_loop	set to true to play endless
	 */
	 ...
	 *
	 * @param String	$s_action	The preload action (auto|metadata|none)
	 */
	 ...
	 *
	 * @param String $s_url		The url
	 * @param String $s_type	The video type
	 */
...
class Video extends Audio {
	 ...
	 *
	 * @param String	$s_icon	The loading icon
	 */
	...
	public function generateItem(){
		/* Generate between */
		if( !empty($this->s_poster))	$this->s_between .= ' poster="'.$this->s_poster.'"';
