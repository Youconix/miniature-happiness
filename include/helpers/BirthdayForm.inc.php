...
class BirthdayForm extends DateForm {
	...
	/**
	 * Sets the javascript class name. Call this function if you have more then one birthday form.
	 ...
	 * @throws DateException	If the end year is in the future
	 ...
	 *
	 * @param int $i_year		The year
	 * @throws DateException	If the start year is in the future
	 ...
	 * Generates the form
	 * 
	 * @param string $s_idDay		The day form name, default birthday
	 * @param string $s_idMonth		The month form name, default birthmonth
	 * @param string $s_idYear		The year form name, default birthyear
     ...
     * 
     * @return HTML_Javascript	The javascript code
     */
