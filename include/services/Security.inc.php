...
class Security extends Service{
   ...
   * 
   * @param String $s_value   The encoded value
   * @return String The decoded value
   */
  public function prepareJsDecoding($s_value){
    $s_value = str_replace(array( '‘', '’' ), array( '&lsquo;', '&rsquo;' ), urldecode($s_value));
  ...
  public function fixDecodeBug($s_text){
    ...
    return str_replace(
      array( '&Atilde;&laquo;', '&Atilde;&curren;', '&Atilde;&yen;', '&Atilde;&sect;', '&Atilde;&uml;', '&Atilde;&copy;',
        '&Atilde;&macr;', '&Atilde;&sup2;', '&Atilde;&sup3;', '&Atilde;&para;', '&Acirc;&copy;', '&amp;rsquo;', '&amp;lsquo;' ), array( '&euml;', '&auml;', '&aring;', '&ccedil;', '&egrave;', '&eacute;', '&iuml;', '&ograve;', '&oacute;', '&ouml;',
        '&copy;', '&rsquo;', '&lsquo;' ), $s_text);
  }
