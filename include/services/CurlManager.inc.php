...
class CurlManager extends Service {
    ...
    /**
     * Sets the timeout with the given value in miliseconds.  Default value is 4000
     *
     * @param int $i_timeout    The timeout in miliseconds
     */
    public function setTimeout($i_timeout){
        Memory::type('int',$i_timeout);
     ...
     * Performs a GET call
     *
     * @param   string  $s_url      The URI to call
     * @param   array   $a_params   The parameters to add to the URI
     ...
     * @param   string  $s_url      The URI to call
     * @param   array   $a_params   The parameters to add to the URI
     * @param   array   $a_body     The body to send
     * @return  string  The content of the called URI
     */
