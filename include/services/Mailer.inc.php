...
class Service_Mailer extends Service {
	...
	/**
	 * Inits the class Service_Mailer
	 */
	public function __construct(){
		...
		$this->s_domainUrl	= Memory::getProtocol().$this->s_domain.Memory::getBase();
	}
	...
	private function sendMail($obj_mailer){
		if( Memory::isTesting() )		return true;
