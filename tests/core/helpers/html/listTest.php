...
class testList extends \tests\GeneralTest
{
    ...
    {
        $s_expected = "<ul ></ul>\n";
        $this->assertEquals($s_expected, $this->listFactory->uNumberedList()
            ->generateItem());
    }
    ...
    {
        $s_expected = "<ol ></ol>\n";
        $this->assertEquals($s_expected, $this->listFactory->numberedList()
            ->generateItem());
    }
    ...
    public function listItem()
    {
        ...
        $this->assertEquals($s_expected, $this->listFactory->createItem($this->s_content)
            ->generateItem());
    }
