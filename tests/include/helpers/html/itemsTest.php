...
class testItems extends GeneralTest{
  ...
  public function canvas(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->canvas()->generateItem());
  }
  ...
  public function stylesheetLink(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->stylesheetLink($s_link, $s_media)->generateItem());
  }
  ...
  public function stylesheet(){
    ...
    $s_expected = "<style>\n<!--\n" . $s_content . "\n-->\n</style>\n";
    $this->assertEquals($s_expected, $this->helper_HTML->stylesheet($s_content)->generateItem());
  }
  ...
  public function javascriptLink(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->javascriptLink($s_link)->generateItem());
  }
  ...
  public function javascript(){
    ...
    $s_expected = "<script>\n<!--\n" . $s_javascript . "\n//-->\n</script>\n";
    $this->assertEquals($s_expected, $this->helper_HTML->javascript($s_javascript)->generateItem());
  }
  ...
  public function metatag(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->metatag($s_name, $s_content)->generateItem());
  }
  ...
  public function header(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->header($i_nr, $s_content)->generateItem());
  }
  ...
  public function link(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->link($s_link, $s_text)->generateItem());
  }
  ...
  public function paragraph(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->paragraph($s_content)->generateItem());
  }
  ...
  public function span(){
    ...
    $this->assertEquals($s_expected, $this->helper_HTML->span($s_content)->generateItem());
  }
