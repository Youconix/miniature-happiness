...
class ForgotPassword extends \core\BaseLogicClass {
	...
	protected function init(){
		$this->init_get	= array('code'=>'string-DB');
		$this->init_post	= array('email'=>'string-DB');
	...
	private function sendEmail(){
        ...
        $this->service_Template->set('notice',$this->service_Language->insert($this->service_Language->get('language/forgotPassword/resetSuccess'),
	 ...
	 * 
	 * @param string $s_notice		The notice, optional
	 */
