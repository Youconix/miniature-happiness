...
class Database
{
    ...
    private function populateFramework()
    {
        ...
        $this->service_QueryBuilder->insert('group_pages', array(
            ...
            1,
            'styles/default/images/captcha.php',
            - 1
        ))->getResult();
        $this->service_QueryBuilder->insert('group_pages', array(
            'groupID',
        ...
        $obj_create->addEnum('level', array(
            '0',
            '1',
            '2'
        ), '0');
        ...
        $obj_create->addEnum('bot', array(
            '0',
            '1'
        ), '0');
        $obj_create->addRow('registrated', 'int', 11, '0');
        $obj_create->addEnum('active', array(
            '0',
            '1'
        ), '0');
        $obj_create->addEnum('blocked', array(
            '0',
            '1'
        ), '0');
        $obj_create->addEnum('password_expired', array(
            '0',
            '1'
        ), '0');
        ...
        $obj_create->addEnum('unread', array(
            '0',
            '1'
        ), '1');
        $obj_create->addPrimary('id')
        ...
        $this->service_QueryBuilder->insert('smileys', array(
            'code',
            'url'
        ), array(
            's',
        ...
        foreach ($this->a_countries as $a_country) {
            ...
            $this->service_QueryBuilder->insert('countries', array(
                'id',
                'country'
            ), array(
                'i',
        ...
        foreach ($this->a_nationalities as $a_nationality) {
            ...
            $this->service_QueryBuilder->insert('nationalities', array(
                'id',
                'nationality'
            ), array(
                'i',
    ...
    public function createUser($s_nick, $s_email, $s_password)
    {
        try {
            ...
            $this->service_QueryBuilder->update('users', 'active', 's', '1')
                ->getWhere()
                ->addAnd('id', 'i', 1);
            $this->service_QueryBuilder->getResult();
            ...
            $this->service_QueryBuilder->update('group_users', 'level', 's', '2')
                ->getWhere()
                ->addAnd('groupID', 'i', 1);
            $this->service_QueryBuilder->getResult();
