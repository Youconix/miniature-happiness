...
class Install extends SettingsMain
{
    ...
    public function __construct()
    {
        ...
        if (defined('DATA_DIR')) {
            $s_dataDir = DATA_DIR . '/settings/';
        }
        
        /* Get base */
        $s_base = $this->getBase();
        
        $this->s_layout = str_replace(array(
            '{step}',
            '{styledir}',
            '{datadir}',
            '{version}',
    ...
    private function init()
    {
        ...
        if (isset($_GET['step']) && $_GET['step'] > 0 && $_GET['step'] <= 6) {
            ...
            if (isset($_POST['step']) && $_POST['step'] > 0 && $_POST['step'] <= 6) {
